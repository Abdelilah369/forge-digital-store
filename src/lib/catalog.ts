...
export const SAMPLE_PRODUCTS: Product[] = [
  {
    ...
    cover_url: "/products/second-brain.jpg",
    preview_urls: [
  ...
  },
  {
    ...
    cover_url: "/products/ai-masterclass.jpg",
    preview_urls: [
      "/products/ai-masterclass.jpg",
  ...
  },
  {
    ...
    cover_url: "/products/analog-grain.jpg",
    preview_urls: [
      "/products/analog-grain.jpg",
  ...
  },
  {
    ...
    cover_url: "/products/prompt-os.jpg",
    preview_urls: [
      "/products/prompt-os.jpg",
  ...
  },
  {
    ...
    currency: "usd",
    category: "design-assets",
    cover_url: "/products/saas-ui-kit.jpg",
    preview_urls: [
      "/products/saas-ui-kit.jpg",
  ...
  },
  {
    ...
    currency: "usd",
    category: "courses-ebooks",
    cover_url: "/products/growth-playbook.jpg",
    preview_urls: [
      "/products/growth-playbook.jpg",
